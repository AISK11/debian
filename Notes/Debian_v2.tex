...
\newline File (\textcolor{file}{\~/.config/i3/config}):
...
\newline File (\textcolor{file}{/etc/i3blocks.conf}):
...
\end{Verbatim}
    \item Configuration:
\newline File (\textcolor{file}{\~/.Xresources}):
