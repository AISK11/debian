...
echo -e "\n[+] Open-SSH server was successfully installed and configured in '/etc/ssh/sshd_config/'." || echo -e "\n[-] ERROR! Open-SSH server could not be successfully installed in '/etc/ssh/sshd_config'!"
